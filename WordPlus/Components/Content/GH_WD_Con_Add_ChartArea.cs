...
{
    public class GH_WD_Con_ChartArea : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_WD_Con_ChartArea class.
        /// </summary>
        public GH_WD_Con_ChartArea()
          : base("Word Area Chart", "WD Area Cht",
              "Construct a Word Area Chart Content Object from a list of numbers",
        ...
        {
            IGH_Goo gooA = null;
            Paragraph title = new Paragraph("Area Chart"); ;
            ...
            Content content = Content.CreateChartAreaContent(title, dataSet, axis, series, colors, (Content.LegendLocations)legend);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.WD_Con_Chart_Area;
            }
        }
        ...
        {
            get { return new Guid("54AE41E6-1A86-42C7-BA3A-8676E0EE6FF0"); }
        }
    }
}