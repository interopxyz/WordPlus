...
namespace WordPlus.Components.Content
{
    public class GH_WD_Con_ChartArea : GH_Component
    {
        ...
        public GH_WD_Con_ChartArea()
          : base("Area Chart", "ChartArea",
              "Construct a Area Chart Content Object from a list of numbers",
        ...
        {
            IGH_Goo gooA = null;
            WdParagraph title = new WdParagraph("Area Chart"); ;
            ...
            WdContent content = WdContent.CreateChartAreaContent(title, dataSet, axis, series, colors, (WdContent.LegendLocations)legend);
